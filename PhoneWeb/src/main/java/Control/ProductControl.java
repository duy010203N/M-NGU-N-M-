    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                out.println("<td>" + N + "</td>");
                out.println("<td style='text-align: center;'><img src='" + imagePath + "' alt='" + N + "' width='100' height='100'></td>"); 
                out.println("<td style='text-align: center;'>" + P + "</td>"); 
            ...
            out.println("<input type='file' class='form-control' required>");
            out.println("</div>");
            out.println("<div class='form-group'>");
            ...
            out.println("<textarea class='form-control' required></textarea>");
            out.println("</div>");
            out.println("<div class='form-group'>");
            ...
            out.println("<script>");
            // Thêm mã JavaScript để xử lý các sự kiện và thao tác với các modal
            out.println("</script>");

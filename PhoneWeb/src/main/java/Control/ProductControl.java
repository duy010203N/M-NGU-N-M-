...
public class ProductControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<div id='editProductModal' class='modal fade'>");
            out.println("<div class='modal-dialog'>");
            out.println("<div class='modal-content'>");
            ...
            out.println("<div class='form-group'>");
            out.println("<label>Name</label>");
            out.println("<input type='text' name='name' id='editName' class='form-control' required>");
            out.println("</div>");
            out.println("<div class='form-group'>");
            out.println("<label>Image</label>");
            out.println("<input type='file' name='image' class='form-control' required>");
            ...
            out.println("<div class='form-group'>");
            out.println("<label>Price</label>");
            out.println("<input type='text' name='price' id='editPrice' class='form-control' required>");
            out.println("</div>");
            out.println("<div class='form-group'>");
            out.println("<label>Title</label>");
            out.println("<input type='text' name='title' id='editTitle' class='form-control' required>");
            out.println("</div>");
            out.println("<div class='form-group'>");
            out.println("<label>Description</label>");
            out.println("<textarea name='description' id='editDescription' class='form-control' required></textarea>");
            out.println("</div>");
            out.println("<div class='form-group'>");
            out.println("<label>CateID</label>");
            out.println("<input type='text' name='cateID' id='editCateID' class='form-control' required>");
            out.println("</div>");
            out.println("<div class='form-group'>");
            out.println("<label>Sell_ID</label>");
            out.println("<input type='text' name='sellID' id='editSellID' class='form-control' required>");
            out.println("</div>");
            out.println("</div>");
            out.println("<div class='modal-footer'>");
            out.println("<input type='button' class='btn btn-default' data-dismiss='modal' value='Cancel'>");
            ...
            out.println("        $('#editProductModal').modal('show');"); // Show the modal for editing
            out.println("    });");
            out.println("});");
            out.println("</script>");
